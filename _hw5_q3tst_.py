...
# this block generates random trees and angles
# for i in range(5):
#     random_points = [Point(random.randint(0, 10), random.randint(0, 10)) for i in range(5)]
#     print(random_points)
# for i in range(5):
#     print(round(random.uniform(0, math.pi * 2),2))
